...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF4EA302);
  late Color secondary = const Color(0xFFB7B81A);
  late Color tertiary = const Color(0xFF698D1C);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF2A2A2A);
  late Color secondaryText = const Color(0xFFA0A0A0);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF4EA302);
  late Color accent2 = const Color(0xFFEDAE10);
