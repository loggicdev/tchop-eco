      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case DriverDocumentsRow:
            return DriverDocumentsRow(data);
          case FcmTokensRow:
          ...
          case ChatRow:
            return ChatRow(data);
          case DriverStatusRow:
            return DriverStatusRow(data);
          case AddressHistoryRow:
            return AddressHistoryRow(data);
          case GeographyColumnsRow:
            return GeographyColumnsRow(data);
          case DynamicMultipliersRow:
            return DynamicMultipliersRow(data);
          case SystemLogsRow:
            return SystemLogsRow(data);
          case RatingsRow:
