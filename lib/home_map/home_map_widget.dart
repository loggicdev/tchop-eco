...
class _HomeMapWidgetState extends State<HomeMapWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await actions.registerFcmToken();
    ...
    _model.textFieldFocusNode!.addListener(
      () async {
        context.pushNamed(StartRideWidget.routeName);
      },
    );
      ...
      child: Scaffold(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(20.0, 38.0, 20.0, 26.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      context.pushNamed(RidesWidget.routeName);
                                    },
                                    child: Row(
                                      mainAxisSize: MainAxisSize.max,
                                      children: [
                                          ...
                                          children: [
                                            ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(8.0),
                                              child: Image.asset(
                                                'assets/images/message-square-more.png',
                                                width: 26.0,
                                                height: 26.0,
                                                fit: BoxFit.cover,
                                              ),
        ...
        body: Stack(
          children: [
            ...
            if (FFAppState().rideInProgress == false)
              Align(
            ...
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(16.0, 59.0, 0.0, 0.0),
              child: InkWell(
                splashColor: Colors.transparent,
                focusColor: Colors.transparent,
                hoverColor: Colors.transparent,
