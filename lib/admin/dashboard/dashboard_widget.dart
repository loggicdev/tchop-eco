...
class _DashboardWidgetState extends State<DashboardWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      await action_blocks.atualizarDashAdmin(context);
    });
                                                ...
                                                child: ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          8.0),
                                                  child: SvgPicture.asset(
                                                    'assets/images/Featured_icon_(1).svg',
                                                    width: 48.0,
                                                    height: 48.0,
                                                    fit: BoxFit.cover,
                                                  ),
                                                ...
                                                child: ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          8.0),
                                                  child: SvgPicture.asset(
                                                    'assets/images/Featured_icon_(2).svg',
                                                    width: 48.0,
                                                    height: 48.0,
                                                    fit: BoxFit.cover,
                                                  ),
                                        ...
                                        dataRowBuilder: (homeItem, homeIndex,
                                          ...
                                          cells: [
                                                      ...
                                                      Flexible(
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Flexible(
                                                              child: Text(
                                                                '${homeItem.totalRidesByDriver.toString()}  corridas',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                                    .override(
                                            ...
                                            Align(
                                              ...
                                              child: StatusWidget(
                                                key: Key(
                                                    'Keygqm_${homeIndex}_of_${home.length}'),
